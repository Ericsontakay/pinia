              ...
              <div class="d-flex justify-end mb-2">
                ...
                <v-menu v-model="menu2" :close-on-content-click="false">
                  <template v-slot:activator="{ props }">
                    <v-text-field v-model="date" variant="outlined" density="compact" prepend-inner-icon="mdi-calendar"
                      hide-details readonly style="max-width: 180px;" v-bind="props" />
                  </template>

                  <v-date-picker v-model="date" color="primary" hideHeader hideWeekdays></v-date-picker>
                </v-menu>
              </div>
...
<<<<<<< HEAD
            ...
            <v-row>
              <v-col>
                <v-text-field label="Nome" variant="outlined" density="compact" prepend-inner-icon="mdi-account"
                  hide-details />
              </v-col>

              <v-col>
                <v-text-field label="Telefone" variant="outlined" density="compact" prepend-inner-icon="mdi-phone"
                  hide-details />
              </v-col>

              <v-col>
                <v-text-field label="Email" variant="outlined" prepend-inner-icon="mdi-email" density="compact"
                  hide-details />
              </v-col>
            </v-row>
          </div>
            ...
            <v-table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <v-text-field variant="outlined" density="compact" prefix="R$" hide-details />
                  </td>

                  <td>
                    <v-text-field variant="outlined" density="compact" type="number" hide-details />
                  </td>
                  ...
                  <td>
                    <div class="d-flex align-center justify-end">
                      ...
                      <v-btn icon="mdi-trash-can-outline" size="small" variant="plain" />
                    </div>
                  </td>
                </tr>
                <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="text-right d-flex">
                            <v-text-field variant="outlined" density="compact" hide-details class="mr-2" />

                            <v-select variant="outlined" density="compact" :items="['%', 'R$']" hide-details
